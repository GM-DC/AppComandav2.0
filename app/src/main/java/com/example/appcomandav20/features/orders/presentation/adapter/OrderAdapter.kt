package com.example.appcomandav20.features.orders.presentation.adapter
    ...
    inner class holderPedido(private val view: View): RecyclerView.ViewHolder(view){
        ...
        fun render (data: ListOrdersModel, position: Int) {
            ...
            if(data.estadoPedido=="PENDIENTE"){
                binding.ivBtnDisminuir.isVisible = true
                binding.ivBtnAumentar.isVisible = true
                binding.ivBtnObservation.isVisible = true
